    ...
    <div className="animate-in fade-in duration-700 max-w-7xl mx-auto w-full py-20 px-8 lg:px-16">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        <div className="bg-white/5 p-10 lg:p-14 rounded-2xl">
          <form className="space-y-12" onSubmit={(e) => { e.preventDefault(); alert('Message received!'); }}>
            ...
            <div className="space-y-1">
              ...
              <select className="w-full bg-transparent border-0 border-b border-white/20 py-4 text-lg font-light focus:ring-0 focus:border-primary transition-colors outline-none appearance-none cursor-pointer">
                <option className="bg-background-dark">Classical Piano Instruction</option>
                <option className="bg-background-dark">Performance Preparation</option>
                <option className="bg-background-dark">Music Theory & Composition</option>
              </select>
            </div>
            <div className="space-y-1">
            ...
            <button 
              className="w-full bg-primary text-background-dark font-bold py-5 rounded-lg uppercase tracking-[0.2em] text-sm hover:brightness-110 transition-all flex items-center justify-center gap-2 group" 
              type="submit"
            >
              Send Inquiry
